...
import static io.github.mfaisalkhatri.stalereferenceexception.Helper.chainMultipleExpectedConditions;
...
public class TestExampleStaleElementReferenceException extends BaseTest {
    ...
    public void createStaleElementReferenceException () {
        final WebElement pageLink = driver.findElement (By.linkText ("Table Data Search"));
        pageLink.click ();

...
public class ThreadSleepDemoTests {
    ...
    public void testLogin () throws InterruptedException {
        ...
        final String myAccountHeaderText = this.driver.findElement (By.cssSelector ("#content h2"))
            .getText ();
    ...
    public void testWebsiteNavigation () throws InterruptedException {
        ...
        this.driver.findElement (By.linkText ("Shop by Category"))
            .click ();

        Thread.sleep (1000);

        this.driver.findElement (By.cssSelector (".entry-component .entry-widget nav.navbar ul li:nth-child(5) a"))
            .click ();
    ...
    public void testWebsiteNavigationWithExplicitWait () {
        ...
        wait.until (ExpectedConditions.elementToBeClickable (By.linkText ("Shop by Category")))
            .click ();

        wait.until (ExpectedConditions.elementToBeClickable (
                By.cssSelector (".entry-component .entry-widget nav.navbar ul li:nth-child(5) a")))
            .click ();
    }

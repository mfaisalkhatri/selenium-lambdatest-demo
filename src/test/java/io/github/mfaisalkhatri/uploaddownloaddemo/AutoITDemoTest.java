...
public class AutoITDemoTest {
    ...
    public void testFileUploadDownload () throws IOException, InterruptedException {
        ...
        this.driver.get ("https://www.ilovepdf.com/pdf_to_word");

        this.driver.findElement (By.id ("pickfiles"))
            .click ();
        Thread.sleep (5000);
        ...
        final WebElement convertToWordBtn = this.driver.findElement (By.id ("processTask"));
        assertTrue (convertToWordBtn.isDisplayed ());

        convertToWordBtn.click ();
        Thread.sleep (5000);

        final WebElement downloadWordFile = this.driver.findElement (By.id ("pickfiles"));
